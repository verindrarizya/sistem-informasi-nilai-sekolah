            ...
            <div class="container-fluid dashboard-content">
                ...
                <div class="col-xl-12 col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="card">
                                ...
                                <div class="card-body">
                                <?php echo form_open('admin/cetak_nilai_mapel');?>
                                <input type="hidden" name="kdmapel" value="<?php foreach($results as $d){ echo $d->kdmapel; break;} ?>">
                                <div class="form-row">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><?php echo $ket;?></td>
                                                <td>
                                                <?php echo anchor('admin/hapus_nilai/'.$d->kdmapel."/".$d->nis, '<i class="fa fa-fw fa-trash"></i> Hapus', 'title="Hapus" class="btn btn-danger btn-sm"');?>
                                                </td>
                                            </tr>
